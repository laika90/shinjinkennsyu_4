...
void collecting_LED(int color_select){
  ...
  while(1){
    while(1){
      int color_mean = color_mean(color_select);
      array_color[0] = array_color[1];
      array_color[1] = array_color[2];
      array_color[2] = redred;
      if(array_color[1] > start_val * 1.3 && array_color[0] < array_color[1] && array_color[2] < array_color[1]){
    ...
    double Distance = measuring_distance();
...
void loop(){
  ...
  while(1){
    while(1){
      int color_mean = color_mean(select_infrared);
      array_color[0] = array_color[1];
      array_color[1] = array_color[2];
      array_color[2] = color_mean;
      if(array_color[1] > start_val * 1.3 && array_color[0] < array_color[1] && array_color[2] < array_color[1]){
        turn_right(turn_speed);
        delay_log(200);
        stop();
